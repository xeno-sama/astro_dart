...
List<double> dataVenus(double N, double i, double a, double w, double e,
...
// Шаг 2 - вычислить прямоугольные координаты
...
*/
// # print(RA, Decl, R)
// # print(xequat,yequat, zequat, ygeoc, xgeoc)
// # print(x_eclip, y_eclip, z_eclip)
// # print(N, i, w, a, e, M)
// # print(r, v, E)
